...
(defparameter *aima-root* (truename "/mnt/diskData/Sources/LispProjects/mi-paa/paa5-knapsack/") ; <<<<<<<< Edit this <<<<<<
...
(def-aima-system search (agents)
  ...
  ("search" / "test-search" 
   ...
   ;;("environments" / "prob-solve")
   ("domains" / "cannibals" "nqueens" "path-planning" 
